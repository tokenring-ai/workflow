...
export const description = "/workflow <subcommand> [args] - Run a workflow with optional arguments";
...
async function handleDebugCommand(args, workflowService) {
 if (!args) {
  ...
  workflowService.systemLine(`Workflow debug mode is currently: ${currentDebugState ? 'ON' : 'OFF'}`);
