...
import WorkflowService from "../WorkflowService.js";
  ...
  export const description = "/plan <prompt> - Generate a plan of AI tasks from the prompt";
  ...
  export async function execute(remainder, registry) {
    ...
    try {
      ...
      const plan = await workflowService.run(planTasksWorkflow, { prompt: remainder }, registry);
      ...
      chatService.systemLine("Plan saved. Use /apply to execute the plan when ready.");
    } catch (error) {
